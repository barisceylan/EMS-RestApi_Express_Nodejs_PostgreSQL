...
app.post("/locations", async (req, res) => {
  try {
    ...
    const newLocation = await pool.query(
      "INSERT INTO location (location, address, zipcode) VALUES ($1, $2,$3)",
...
app.put("/locations/:loc_id", async (req, res) => {
  try {
    ...
    const updateLocation = await pool.query(
      "UPDATE location SET location = $1, address=$2, zipcode = $3 WHERE loc_id = $4",
      [location, address, zipcode, loc_id]
    );
